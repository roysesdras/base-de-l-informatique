...
class PHP_Email_Form {
  ...
  public function send() {
    ...
    try {
      ...
      ✔️✔️✔️👍Merci ! <br> Votre tutoriel vous parviendra sous peu. <br> Pour toute question ou assistance, nous contacter <a href="mailto:serviceclient@techinfo360.tech">techinfo360</a> <br><br> En attendant, n\'oubliez pas de consulter notre site <a href="https://techinfo360.tech/">techinfo360.tech</a> pour plus de ressources et d\'informations sur l\'informatique.     </p>';
    } catch (Exception $e) {
